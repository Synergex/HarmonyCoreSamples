...
rem set ENABLE_RELATIONS_NOVALIDATION=-define ENABLE_RELATIONS_NOVALIDATION
...
set ENABLE_TRADITIONAL_BRIDGE_GENERATION=YES
set ENABLE_TRADITIONAL_BRIDGE_CLIENT_GENERATION=YES
...
if DEFINED ENABLE_TRADITIONAL_BRIDGE_CLIENT_GENERATION (
